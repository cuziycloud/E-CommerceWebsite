            ...
            {editingAddressId === address._id ? (
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    value={editAddress?.name || address.name}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editAddress?.phone || address.phone}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editAddress?.region || address.region}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    value={editAddress?.fullAddress || address.fullAddress}
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-4xl sm:w-full">
            <div className="bg-white p-6">
              <div className="flex justify-between items-start mb-6">
                <h2 className="text-3xl font-bold text-center w-full">Order Details</h2>
